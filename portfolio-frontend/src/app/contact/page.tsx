...
const ContactPage = () => {
  ...
  return (
<div className="min-h-screen flex items-center justify-center px-6 dark:from-gray-900 dark:to-black">
  <div className="flex flex-wrap  dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden max-w-5xl w-full">
