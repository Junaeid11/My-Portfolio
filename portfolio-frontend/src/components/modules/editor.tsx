...
const MenuBar = ({ editor }) => {
  ...
  return (
    <div className="lg:flex w-full lg:items-center lg:justify-center md:flex md:items-center md:justify-center">
...
const Editor = ({ content, setContent }) => {
  ...
  return (
    <div className="w-full lg:flex md:flex bg-red-300 flex-col items-center justify-center">
      <MenuBar  editor={editor} />
      <EditorContent
        editor={editor}
        className="bg-white h-[40vh]  border-2 border-black w-full  p-2 rounded-md focus:border-none"
      />
    </div>
  );
};
